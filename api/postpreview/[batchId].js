...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Generate HTML preview page with timestamp to prevent caching
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Content Preview - @${batch.account_username} | easypost.fun (${timestamp})</title>
    <!-- DEPLOYMENT ID: ${Date.now()}-${Math.random().toString(36).substring(7)} - Force fresh deployment -->    
    <!-- Favicon -->
        ...
        async function rerollSelectedImages() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    console.log('🔄 Reloading page to show new images...');
